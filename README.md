...
This repository contains OIC integration that is used to  extract BIP report data using SOAP API call to oracle fusion application that extracts the report data in the form  of Base 64 content.
